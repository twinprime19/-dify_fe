...
export async function GET() {
    const config = {
        ...
        API_URL: process.env.NEXT_PUBLIC_API_URL ? process.env.NEXT_PUBLIC_API_URL : 'Missing ❌',
    ...
    return NextResponse.json({
        ...
        config,
        ready: !!(process.env.NEXT_PUBLIC_APP_ID && process.env.NEXT_PUBLIC_APP_KEY && process.env.NEXTAUTH_SECRET)
    })
} 